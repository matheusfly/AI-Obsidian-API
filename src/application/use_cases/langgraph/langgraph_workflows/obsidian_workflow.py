...
Official LangGraph CLI compatible workflow
"""
...
def list_vault_files(state: ObsidianState) -> ObsidianState:
    ...
    result = list_obsidian_files.invoke({
...
def search_notes(state: ObsidianState) -> ObsidianState:
    ...
    result = search_obsidian_notes.invoke({
        "vault_name": state["vault_name"],
...
def read_current_file(state: ObsidianState) -> ObsidianState:
    ...
    result = read_obsidian_file.invoke({
        "vault_name": state["vault_name"],
...
def create_summary_note(state: ObsidianState) -> ObsidianState:
    ...
    summary_content = f"""# LangGraph-Obsidian Integration Workflow Summary
...
"""
    ...
    result = write_obsidian_file.invoke({
        "vault_name": state["vault_name"],
...
# Export the workflow for LangGraph CLI
workflow = create_obsidian_workflow()
