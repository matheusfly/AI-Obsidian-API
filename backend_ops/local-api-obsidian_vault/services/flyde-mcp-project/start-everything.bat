@echo off
echo 🚀 Starting Flyde UI with Active MCP Debugging and Playwright Testing
echo =====================================================================

echo.
echo 🔍 Starting MCP Debug Monitor...
start "MCP Debug Monitor" cmd /k "cd /d %~dp0 && node mcp-debug-monitor.js"

echo.
echo 🌐 Starting Flyde Web Server...
start "Flyde Web Server" cmd /k "cd /d %~dp0 && node mcp-web-server.js"
...
start "Playwright Tests" cmd /k "cd /d %~dp0 && node flyde-playwright-test.js"
