#!/usr/bin/env python3
"""
Validation Testing: Embedding Quality
...
class EmbeddingQualityValidator:
    ...
    def generate_embedding(self, text: str) -> np.ndarray:
        """Generate embedding for text using the topic extractor"""
        try:
            # Use the topic extractor's embedding model
            # For now, we'll use a simple approach - in production, this would use the actual embedding service
