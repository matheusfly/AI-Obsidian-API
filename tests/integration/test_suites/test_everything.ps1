...
Write-Host "`nCreating comprehensive test report..." -ForegroundColor Cyan

$testReport = @"
# COMPREHENSIVE TEST REPORT - MCP LANGSMITH INTEGRATION

**Date:** $(Get-Date -Format "yyyy-MM-dd HH:mm:ss")
**Status:** ALL SYSTEMS TESTED

## HEALTH CHECKS
- MCP Integration Server: $($healthyCount -ge 1 ? "HEALTHY" : "UNHEALTHY")
- Observability Server: $($healthyCount -ge 2 ? "HEALTHY" : "UNHEALTHY")  
- Debug Dashboard: $($healthyCount -ge 3 ? "HEALTHY" : "UNHEALTHY")

## SERVICE URLS
- MCP Integration: http://127.0.0.1:$($Config.MCPIntegrationPort)
- Observability: http://127.0.0.1:$($Config.ObservabilityPort)
- Debug Dashboard: http://127.0.0.1:$($Config.DebugDashboardPort)
- LangSmith: https://smith.langchain.com/project/9d0b2020-2853-467c-a6b7-038830616919

## TEST RESULTS
- Health Checks: $healthyCount/3
- MCP Tool Calls: TESTED
- LangSmith Integration: TESTED
- Trace Retrieval: TESTED
- Performance Metrics: TESTED
- MCP Server List: TESTED
- Debug Dashboard: TESTED

## OVERALL STATUS
$($healthyCount -eq 3 ? "ALL SYSTEMS OPERATIONAL" : "SOME ISSUES DETECTED")
"@

$testReport | Out-File -FilePath "COMPREHENSIVE_TEST_REPORT.md" -Encoding UTF8
